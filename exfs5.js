...
(function () {
    ...
    var COMPONENT = 'exfs_online_v5';
    var FRAME_COMPONENT = 'exfs_frame_v5';

    if (window.__exfs_v5_loaded) return;
    window.__exfs_v5_loaded = true;
    ...
    function startPlugin() {
        if (window.__exfs_v5_started) return;
        ...
        try {
            ...
            window.__exfs_v5_started = true;

            console.log('EX-FS', 'v' + VERSION + ' started');
            diag('1/6 v' + VERSION + ' завантажено');
        } catch (e) {
